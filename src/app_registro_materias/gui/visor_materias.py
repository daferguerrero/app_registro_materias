...
class Aplicacion_Gui(QWidget):
  ...
  def __init__(self, logica):
    ...
    self.title = 'app registro materias'
    self.left = 80
    self.top = 80
    self.width = 300
    self.height = 320
    self.inicializar_GUI()  # Inicializamos la ventana principal
    self.logica = logica # Asignamos el valor de la lógica
